...
function Signup(){
    ...
    // console.log(isRegistered["user_id"]);
    ...
    return (
        ...
        <div className="w-[100vw] h-[100vh] content-center text-left m-auto">
            
            <h2 className="m-auto text-center text-4xl mb-10">Register Me</h2>
            <form onSubmit={goRegister} method="POST" className="m-auto w-[95vw] lg:w-[40vw] align-center bg-white p-10 rounded-lg">
